  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" action="${pageContext.request.contextPath }/login/process" method="post">
        ...
        <input type="email" id="inputEmail" name = "mem_id" class="form-control" placeholder="Email address" required autofocus value ="brown">
        <label for="inputPassword" class="sr-only"><spring:message code="login.password"/></label>
        <input type="password" id="inputPassword" class="form-control" placeholder="Pass" name ="mem_pass" required value = "brownPass">
        <div class="checkbox">
          <label>
